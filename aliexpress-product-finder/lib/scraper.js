...
if (!UPSTASH_REDIS_URL || !UPSTASH_REDIS_TOKEN) {
  throw new Error(
    "Please set UPSTASH_REDIS_URL and UPSTASH_REDIS_TOKEN in your environment variables"
  );
}
...
const CURRENCY_CONVERSION_API_URL =
  "https://api.exchangerate-api.com/v4/latest/USD"; // Replace with your currency conversion API URL
    ...
    return Promise.all(
      Array.from(
        ...
        const priceInUSD = price
          ? await convertToUSD(price, localCurrency)
          : "No price available";
